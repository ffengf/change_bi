...
exports.More = function (axios_get, use_created) {
    if (use_created === void 0) { use_created = true; }
    var Mixin = /** @class */ (function (_super) {
        ...
        Mixin.prototype.get_list = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, results, count;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), results = _a.results, count = _a.count;
                            this.list = __spreadArrays(this.list, results);
                            this.count = count;
                            return [2 /*return*/];
                    }
                });
        ...
        Object.defineProperty(Mixin.prototype, "disabled", {
            get: function () {
