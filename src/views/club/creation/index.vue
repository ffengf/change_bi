		...
		<ul class="list w70vw min_width1000">
			...
			<li class="item">
				<div class="v1">
					...
					<h3 class="sm-up">
						...
						싶은 분들은 '조 신청'을 해주시면 됩니다. 조 신청의 경우 조장이 대표자가
						되어 클럽지기와 소통하게 됩니다.</p>
					</h3>
				</div>
				<div class="v2">
			...
			<li class="item">
				<div class="v1">
					...
					<h3 class="sm-up">
						<p>미션 중간에 특별 미션으로 레포트 또는 합평회를 소화하게 됩니다. 개인
						신청으로 활동하는 클러버는 일정에 맞추어 레포트를 제출하게 됩니다. 조
						단위로 신청한 모임에서는 자체적으로 합평회를 진행합니다. 레포트와
						합평회, 조금은 어렵게 느껴지신다고요? 걱정 마세요! 레포트는 샘플을,
						합평회는 가이드를 마련해서 제공할 예정이에요. :)</p>
					</h3>
				</div>
				<div class="v2">
