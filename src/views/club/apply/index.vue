    ...
    <div class="creation">
		...
		<div class="content w70vw min_width1000">
			...
			<h1 class="mid sm-down">
				...
				<p>어려워하지 마세요 연결되면 환하게 밝힐 수 있어요.</p>
			</h1>
			<h1 class="mid sm-up">
		...
		<div class="flow w70vw min_width1000">
			...
			<div class="text_box sm-down">
				<div>
					...
					<h2>
						<p>클럽에 따라 미션은 다양하게 구성됩니다. 글을 쓰거나 사진을 찍거나,</p>
						<p>영상을 촬영해야 할지도 몰라요.  며칠 동안 그림을 그리고 달리기를 하고,</p>
				...
				<div>
					...
					<h2>
						...
						<p>④ '프로 인증러' '프로 댓글러' '프로 수다러' 에게는 필라멘트 굿즈를 선물로 드려요.</p>
					</h2>
				</div>
			</div>
