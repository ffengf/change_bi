		...
		<ul class="list w70vw min_width1000">
			<li class="item">
				<div class="v1">
					...
					<h3 class="sm-up">
						<p>함께 뿌리고 거두는 재미. 작심삼일은 누구나 하니까, 우린 '작심삼개월'
						해봐요. 하다가 실패해도 나 혼자만 그런 건 아닐 테니까.
			...
			<li class="item">
				<div class="v1">
					...
					<h3 class="sm-up">
						<p>등하교, 출퇴근, 살림하고 놀기도 빠듯한 우리! 한 달 동안 한 권의 책을
						천천히 읽으며 가벼운 미션을 인증한 후, 조금 더 풍성한 대화 모임을
						꾸립니다.</p>
					</h3>
				</div>
				<div class="v2">
			...
			<li class="item">
				<div class="v1">
					...
					<h3 class="sm-up">
						<p>'같은 목표'가 아니라 '각자의 목표'를 지향하는 우리! 저마다의 속도로 읽고,
						실천하고, 응원하고 친해지다 보면 어느새 누구나 부러워하는 커뮤니티!</p>
					</h3>
				</div>
				<div class="v2">
